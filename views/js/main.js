...
var resizePizzas = function(size) {
  ...
  // Using a percent width eliminates the need to get the offsetWidth of the element, so the elem parameter is removed.
  ...
  function changePizzaSizes(size) {
    ...
    // Create a variable to store the selector output
    ...
    for (var i = 0, len = randomPizzaContainers.length; i < len; i++) {
      ...
      // This eliminates repeating the reading and writing layout and hence
...
function updatePositions() {
  ...
  // Create a variable to store the scrollTop value of the body element
  // This eliminates forced syhcronous layout
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  var numPizzas = cols * Math.ceil(screenHight / s);
